...
class Currency {
  static Future<num> to(String fromISO, String toISO) async {
    final result = await http.get(
      'https://free.currconv.com/api/v7/convert?q=${fromISO}_$toISO,${toISO}_$fromISO&compact=ultra&apiKey=$currencyKey',
    );
    if (result.statusCode == 200) {
      Map<String, dynamic> map = jsonDecode(result.body);
      dynamic _to = map['${fromISO}_$toISO'];
